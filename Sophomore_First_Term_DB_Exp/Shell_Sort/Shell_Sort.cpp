// Shell_Sort.cpp : Defines the entry point for the console application.
//
...
void test1()
{
	...
	//int x = 0;
	SL1.shellSort( SL1.getArrayLength() / 2 );
...
void test2()
{
	...
	//int y = SL1.getArrayLength() - 1;
	//int x = 0;
	SL1.shellSort( SL1.getArrayLength() / 3 );
...
void test3()
{
	...
	//int y = SL1.getArrayLength() - 1;
	//int x = 0;
	SL1.shellSort( SL1.getArrayLength() / 5 );
...
void test4()
{
	...
	//int y = SL1.getArrayLength() - 1;
	//int x = 0;
	SL1.shellSort( SL1.getArrayLength() * 0.618 );
